  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="dashboard-summary dashboard-summary--compact">
        <div className="dashboard-summary-card dashboard-summary-card--compact">
      ...
      <div className="dashboard-main-grid">
        <div className="dashboard-main-left">
          <h2 className="dashboard-section-title">Productivity Insights</h2>
          <ProductivityCharts />
        </div>
        <div className="dashboard-main-right">
          <h2 className="dashboard-section-title">Task Analytics</h2>
          <div className="dashboard-charts dashboard-charts--vertical">
